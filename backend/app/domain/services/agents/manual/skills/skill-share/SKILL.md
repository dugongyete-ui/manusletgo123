---
name: skill-share
description: A skill that creates new Dzeck skills and automatically shares them on Slack using Rube for seamless team collaboration and skill discovery.
...
- **Create new Dzeck skills** with proper structure and metadata
...
```
When you ask Dzeck to create a skill called "pdf-analyzer":
