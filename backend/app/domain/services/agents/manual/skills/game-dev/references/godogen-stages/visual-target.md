...
> **DZECK OVERRIDE:** Generate the reference image using the `image_generate` tool (not godogen's paid image CLI). Everything else about this stage's *intent* applies. See `references/dzeck-adaptations.md` §2.
