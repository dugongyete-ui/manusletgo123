...
- Calibrate the number of steps to the task's real complexity:
  ...
  * Any task that will create or modify files: the first step may begin by orienting in the workspace — a quick look at what already exists and what the project/ operating manual expects — before building. One look, not a research phase.
