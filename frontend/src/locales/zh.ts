export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Dzeck Computer': 'Dzeck 的电脑',
  'Dzeck is using': 'Dzeck 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give Dzeck a task to work on...': '给 Dzeck 一个任务...',
  // Shell tools
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Dzeck': '登录 Dzeck',
  'Register to Dzeck': '注册 Dzeck',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to Dzeck': '注册成功！欢迎使用 Dzeck',
  ...
  'You are viewing a completed Dzeck task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 Dzeck 任务。回放将在 {countdown} 秒后自动开始。',
  // Claw Page
  ...
  'Chat Freely via Dzeck': '通过 Dzeck 自由对话',
  ...
  'Get Started': '立即开始',
  'Create Dzeck Claw': '创建 Dzeck Claw',
  'One-click OpenClaw deployment by Dzeck': 'Dzeck 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
  'Create': '创建',
