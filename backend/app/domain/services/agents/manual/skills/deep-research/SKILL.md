...
- Use the `task_delegate` tool for parallel processing of subtasks

## Writing the Final Report

When writing the final research report, MUST also read and follow the `technical-writing` skill (`project/skills/technical-writing/SKILL.md`); it defines how the report must be written and formatted.
